...
export function activate(context: vscode.ExtensionContext) {
  ...
  let removeAllCommentsCommand = vscode.commands.registerCommand(
  ...
  let removeSingleLineCommentsCommand = vscode.commands.registerCommand(
  ...
  let removeMultilineCommentsCommand = vscode.commands.registerCommand(
